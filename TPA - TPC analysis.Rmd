...
GC.plot <- TPA.df %>%
  ...
  scale_fill_manual(labels = treatment.labs, values=c("#981313","#D0A438", "#0F5961", "#4770B3", "#848484")) +
  theme_bw() +
...
TPC.plot <- TPC.preds %>%
  ...
  scale_y_continuous(expression(bold(Maximum~growth~rate~(d^-1))), limits = c(NA,NA)) +
  scale_colour_manual(values=c("#981313","#D0A438", "#0F5961", "#4770B3", "#848484")) +
  scale_fill_manual(values=c("#981313","#D0A438", "#0F5961", "#4770B3", "#848484")) +
  theme_bw() +
...
TPC.EE_param.plot <- TPC.EE_param %>%
  ...
  scale_colour_manual(labels = treatment.labs, values=c("#848484","#4770B3", "#0F5961", "#D0A438", "#981313")) +
  scale_fill_manual(labels = treatment.labs, values=c("#848484","#4770B3", "#0F5961", "#D0A438", "#981313")) +
  facet_wrap(.~param, ncol = 2, scales = 'free', labeller = param_labels) +
  #coord_flip() +
...
PCA.TPC_biplot <- fviz_pca_biplot(PCA.TPC, repel = TRUE,
                             ...
                             palette = c("#981313","#D0A438", "#0F5961", "#4770B3", "#848484"),
                             #alpha.var ="contrib",
                             col.var = "black",
