...
```{r}
#Import data into R
EE_sum.df <- read_xlsx("./GCB dataset.xlsx", sheet = 1)

TPC_sum.df <- read_xlsx("./GCB dataset.xlsx", sheet = 9) %>%
...
PCA_sum.df <- read_xlsx("./GCB dataset.xlsx", sheet = 10)
...
PCA.sum_biplot_27C <- fviz_pca_biplot(PCA.sum_27C, repel = TRUE,
                             ...
                             fill.ind = PCA.sum.group3_27C, col.ind = PCA.sum.group3_27C, palette = c(
                               "#8B0000","#E4B031", "#26727B", "#4770B3", "#58595b",
                               "#8B0000","#E4B031", "#26727B", "#4770B3", "#58595b",
                               "#8B0000","#E4B031", "#26727B", "#4770B3", "#58595b"),
  ...
  scale_colour_discrete(labels = treatment.labs, type = c("#8B0000","#E4B031", "#26727B", "#4770B3", "#58595b"),
...
Export plot
```{r}
ggsave(plot = PCA.plots, "TPA - PCA summary.pdf", 
       path = "./",
       width = 10,
       height = 10,
       units = 'in',
...
ggsave(plot = GenCTmax.plot, "TPA - generations v CTmax.pdf", 
       path = "./",
       width = 10,
       height = 7.5,
       units = 'in',
